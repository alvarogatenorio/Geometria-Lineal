...
\begin{exa}[Parametrización de cónicas]\label{C8_exa_parametrizacion_parabola}
	...
	\begin{equation*}
	 C=\{(\theta^2:\theta:1)\tq \theta\in\overline{\K}\}
	\end{equation*}
	...
	\begin{equation*}
		C=\{(dsakdjalksjdkla)\tq \theta\in\overline{\K}\}
	\end{equation*}
\end{exa}
...
\begin{lem}
	...
	C=\{(p_1(\theta):p_2(\theta):p_3(\theta))\tq\theta\in\overline{\K}\}
	\end{equation}
...
\begin{exa}[Aplicación del Teorema de Steiner] HACER CUENTAS EN SAGE
	...
	\begin{equation*}
		\mc{C}=\{(gsdgfsdadgdfghdf)\tq \theta\in\overline{\K}\}
	\end{equation*}
