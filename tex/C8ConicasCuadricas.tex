...
Nos queda por último hablar de la recta polar de un punto \tb{perteneciente a la cónica} no degenerada $C$. Aunque dedujimos que los coeficientes de la recta Polar($Q$) eran $AQ$ (donde $A$ es la matriz de la cónica) suponiendo que $Q$ era un punto exterior a la cónica, tomaremos esto como válido también para puntos de la cónica. Es importante recalcar que en este caso no tenemos la propiedad de la cuaterna armónica.
...
\begin{defi}[Cónica dual asociada a una cónica no degenerada]
	Dada una cónica no degenerada $C$, las rectas tangentes a $C$ son una cónica de rectas en el dual denominada \ti{cónica dual}.
\end{defi}
\begin{center}
...
Sea $C$ una cónica degenerada tal que el rango de su matriz $A$ es $2$.
